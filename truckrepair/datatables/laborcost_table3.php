...
const tableLabor3 = new DataTable('#laborcost_datatable3', {
    ...
    columns: [
        ...
        },
        {
            ...
            defaultContent: '<label class=\"labor3_fileLabel\"><i class=\"bi bi-images pointer\" data-bs-toggle=\"tooltip\" data-bs-placement=\"bottom\" title=\"Upload Files\"/><input type=\"file\" accept=\".jpeg, .jpg, .png, .gif\" name=\"labor3_fileInput\" id=\"labor3_fileInput_\" class=\"labor3_fileInput d-none\"></label>',
            orderable: false
        },
        {
            data: null,
